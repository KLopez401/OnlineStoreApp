        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateAdded = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Products = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: false),
                    Total = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
                    PurchaseDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ReceiptReference = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
